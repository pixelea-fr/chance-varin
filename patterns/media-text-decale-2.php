<?php
/**
 * Title: Media Texte Type 2
 * Slug: ng1-base/media-text-decale-2
 * Categories: media
 * Keywords: up, pixelea
 * Block Types: core/columns
 */
?>
<!-- wp:columns {"metadata":{"name":"Media Texte Décalé Type 2"},"align":"full","className":"media-text-decal-2"} -->
<div class="wp-block-columns alignfull media-text-decal-2"><!-- wp:column {"width":"60%","className":"media-text-decal-2__col1 is-style-default"} -->
<div class="wp-block-column media-text-decal-2__col1 is-style-default" style="flex-basis:60%"><!-- wp:group {"className":"is-style-style4","style":{"spacing":{"padding":{"top":"var:preset|spacing|8","bottom":"var:preset|spacing|8","left":"var:preset|spacing|3","right":"var:preset|spacing|3"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group is-style-style4" style="padding-top:var(--wp--preset--spacing--8);padding-right:var(--wp--preset--spacing--3);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--3)"><!-- wp:heading -->
<h2 class="wp-block-heading">Négociation｜Gérance</h2>
<!-- /wp:heading -->
...
<!-- wp:column {"className":"media-text-decal-2__col2"} -->
<div class="wp-block-column media-text-decal-2__col2"><!-- wp:image {"id":173,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo home_url(); ?>/wp-content/uploads/2025/12/enseigne-notaire.jpeg" alt="" class="wp-image-173"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->