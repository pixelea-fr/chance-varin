...
<h2 class="wp-block-heading has-text-align-center has-large-font-size">L’expertise au bon moment,<br> au bon endroit</h2>
<!-- /wp:heading -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"className":"cover-home-chance-varin"} -->
<div class="wp-block-button cover-home-chance-varin"><a class="wp-block-button__link wp-element-button" href="/contact">Contactez-nous</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover -->