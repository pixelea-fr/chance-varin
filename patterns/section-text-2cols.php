<?php
/**
 * Title: Section texte | 2 cols
 * Slug: ng1-base/section-text-2cols
...
<!-- wp:paragraph -->
<p>Située au cœur des grands haras de Normandie, le Groupe a développé une solide expérience en matière de cession / acquisition de haras, et accompagne ses clients dans l'élaboration de leur projet de création de structure hippique.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph -->
<p>Le pôle dispose également d'un notaire spécialisé dans la gestion du patrimoine des congrégations religieuses et des fondations, maitrisant l'articulation entre le droit canonique et le droit civil. </p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p> L'étude est dotée d'outils numériques des plus modernes (signature électronique des actes, visio conférence, plateforme d'échange de fichiers numériques), lui permettant de garantir à ses clients la qualité, la rapidité et la sécurité juridique qu'ils recherchent.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->