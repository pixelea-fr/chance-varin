 ...
 * Slug: ng1-base/footer-four-columns
 * Categories: footer
		...
		<div class="wp-block-group alignfull">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group" style="padding-right:0;padding-left:0">
					...
					<h3 class="wp-block-heading has-medium-font-size" style="font-style:normal;font-weight:700">Navigation 1</h3>
					<!-- /wp:heading -->
					<!-- wp:pattern {"slug":"ng1-base/hidden-navigation-column"} /-->
                                </div>
				<!-- /wp:group -->
				<!-- wp:group {"style":{"spacing":{"padding":{"right":"0","left":"0"}}},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group" style="padding-right:0;padding-left:0">
					<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"medium"} -->
					<h3 class="wp-block-heading has-medium-font-size" style="font-style:normal;font-weight:700">Navigation 2</h3>
					<!-- /wp:heading -->
		            <!-- wp:pattern {"slug":"ng1-base/hidden-navigation-column"} /-->
				</div>
				<!-- /wp:group -->
